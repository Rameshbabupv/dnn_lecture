Week 10 - DO3 (October 22, 2025)

Comprehensive Lecture Notes - Version 2

Module 4: Convolutional Neural Networks - Technical Deep Dive

**Duration:** 2 hours (8:00 AM - 9:40 AM IST) **Format:** Lecture with demonstrations **Philosophy:** 80% Concepts | 15% Strategic Calculations | 5% Minimal Code
...
• ✅ Understanding of manual feature extraction (edges, SIFT, HOG)
...
• **Tutorial T10 (Tomorrow):** Building first CNN in Keras for Fashion-MNIST

• **Homework (Due Week 11):** Manual convolution calculation + architecture design
...
• Craft texture filters (Gabor filters)

• Engineer shape descriptors (SIFT, HOG)
...
**Tomorrow's Tutorial T10** will walk through this step-by-step!
...
**Today you learned THE CONCEPTS.** **Tomorrow you'll BUILD IT.**
...
Modify Tutorial T10 code (after tomorrow):
...
8. ✅ Write basic CNN in Keras? (See you tomorrow for practice!)
...
✅ **Hour 1:** Understood convolution mathematics (1D, 2D, parameters) ✅ **Hour 2:** Built complete CNN architecture (stacking, pooling, classification) ✅ **Philosophy:** 80% concepts, 15% calculations, 5% code ✅ **Readiness:** Prepared for Tutorial T10 tomorrow

**See you tomorrow for hands-on CNN implementation in Keras!**

--------------------------------------------------------------------------------

**End of Comprehensive Lecture Notes - Version 2** **Last Updated:** October 2025 **Next Session:** Tutorial T10 - Building CNN in Keras (October 23, 2025)